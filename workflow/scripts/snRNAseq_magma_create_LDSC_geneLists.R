...
for (CELL_TYPE in cell_types) {
  ...
  for (QUANTILE in seq(0, 10)) {
    ...
    write.table(rownames(CELL_TYPE_DF), paste0('/scratch/c.c1477909/fetal_brain_snRNAseq_110122/results/q10_gene_lists_for_LDSC/', 
...
file.create(paste0('/scratch/c.c1477909/fetal_brain_snRNAseq_110122/results/q10_gene_lists_for_LDSC/',
